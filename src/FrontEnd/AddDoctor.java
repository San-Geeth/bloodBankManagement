...
public class AddDoctor extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        Doc.setDocName(txtName.getText().trim());
        Doc.setDocPhNumber(Integer.parseInt(txtContact.getText().trim()));
        Doc.setDEmail(txtEmail.getText().trim());
        Doc.setNIC(txtNIC.getText().trim());

        DatabaseLayer.DBUserConnection up = new DBUserConnection();

        up.AddDoctor(Doc);

        JOptionPane.showMessageDialog(rootPane, "Doctor Added.");
        txtName.setText("");
        txtContact.setText("");
        txtEmail.setText("");
        txtNIC.setText("");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            String sql = "update Doctor set DocName='" + Name + "',DPhNumber='" + Phone + "',DEmail='" + Email + "'where DocNIC='" + NIC + "'";
            PreparedStatement prep = con.getDBConnection().prepareStatement(sql);

            prep.execute();

            JOptionPane.showMessageDialog(rootPane, "Doctor details updated successfully!");
