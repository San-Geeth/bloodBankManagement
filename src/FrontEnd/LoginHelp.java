...
public class LoginHelp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("How do I Update or create user?\nFirstly, you should log in from a exsisting user and click on user button on the homepage.\nLog in -> User -> Create user or Update user.\n\nWhat should I do if I forget the password?\nYou have to log in from an exsisting user and you can change the password by updating the User.\nLog in-> User -> Update User -> Change password\n");
